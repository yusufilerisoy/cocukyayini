...
export default async function CokSatanlarPage() {
  ...
  return (
    <div className="container mx-auto px-4">
      <Breadcrumb items={[{ label: 'Kitaplar', href: '/kitaplar' }, { label: 'Çok Satanlar' }]} />

      <h1 className="text-2xl font-extrabold text-gray-900 mb-2">Çok Satanlar</h1>
      <p className="text-sm text-gray-500 mb-8">
        En çok okunan ve sevilen çocuk kitapları.
      </p>
