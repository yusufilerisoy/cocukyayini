...
export default async function BasucuPage() {
  ...
  return (
    <div className="container mx-auto px-4">
      <Breadcrumb items={[{ label: 'Kitaplar', href: '/kitaplar' }, { label: 'Başucu Kitapları' }]} />

      <h1 className="text-2xl font-extrabold text-gray-900 mb-2">Başucu Kitapları</h1>
      <p className="text-sm text-gray-500 mb-8">
        Her çocuğun kitaplığında olması gereken vazgeçilmez eserler.
      </p>
